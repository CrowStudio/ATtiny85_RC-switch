 ...
 * stops. Once the stick's position will go below 1480 µs the switch 
 * will change the polarity of the motor and it will go into reverse 
 * motion, when it comes back to centre the motor once again stops. 
 * If you then again move the stick's position above 1520 µs the switch 
 * will change the polarity back to it's origin and the motor will once 
 * again go into forward motion.
 *  
 */
